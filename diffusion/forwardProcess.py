...
from Utils.miscUtils import extract
...
def forward_process(x_start, t, noise=None):
    if noise is None:
        noise = torch.randn_like(x_start)

    sqrt_alphas_cumprod_t = extract(sqrt_alpha_bars, t,
                                    x_start.shape)  # Read as, extract values at index t from sqrt_alpha_bars and reshape it to match x_start.shape
...
def get_noisy_image(x_start, t):
    ...
    x_noisy = forward_process(x_start, t=t)  # This is a tensor
